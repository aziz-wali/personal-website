...
opacity:.5;
 ...
 .card-img-overlay  span{
   ...
   font-size:50px;
	...
	.card-img-overlay:hover .top-left{
	
	left:0;
	}
	.card-img-overlay:hover .top{
	top:0;
	}
	.card-img-overlay:hover .top-right{
	top:0;
	}
	.card-img-overlay:hover .bottom-right{
	right:0;
	}
	.top-left,.top,.top-right,.bottom-right{
